  ...
  <body>
    ...
    <header>
      <div class="blog-masthead">
        <div class="container">
          <nav class="nav">
            <a class="nav-link active" href="https://getbootstrap.com/docs/4.0/examples/blog/#">Home</a>
            <a class="nav-link" href="https://getbootstrap.com/docs/4.0/examples/blog/#">New features</a>
            <a class="nav-link" href="https://getbootstrap.com/docs/4.0/examples/blog/#">Press</a>
            <a class="nav-link" href="https://getbootstrap.com/docs/4.0/examples/blog/#">New hires</a>
            <a class="nav-link" href="https://getbootstrap.com/docs/4.0/examples/blog/#">About</a>
          </nav>
        </div>
      </div>
    ...
    <script src="{{asset('js/jquery-3.2.1.slim.min.js.download')}}" integrity="sha384-KJ3o2DKtIkvYIK3UENzmM7KCkRr/rE9/Qpg6aAZGJwFDMVNA/GpGFF93hXpG5KkN" crossorigin="anonymous"></script>
